...
public class Ex1 {
    public static void main(String[] args) {
		...
		Rectangle rectangle1 = new Rectangle(1, 1, "green");
		Triangle triangle1 = new Triangle(1, 1, 1, "green");
		Shape figura = triangle1;
		Shape figura2 = rectangle1;
		Shape figura3 = new Rectangle(1,1, "green");


		System.out.println(figura2.equals(figura3)); // Têm cores iguais e areas iguais
		System.out.println(figura2.equals(figura)); // Têm areas diferentes

		
		System.out.println(figura.cor);
		System.out.println(triangle1.cor);
		triangle1.cor = "Vermelho";
		System.out.println(figura.cor);
		...
		for(Shape i: figuras){
			System.out.println(i.getClass().getSimpleName()+ " - " + i.cor);
		}
